$(document).ready(function() {
    ...
    var cross = function(element) { // on click adds the class of cross to the sq
        $(element).addClass('cross');
    };

    var circle = function(element) { // on click adds the class of circle to the sq
        $(element).addClass('circle');
    };

    var clickCount = 1;

    var playMove = function() { //assigns even clicks to circles and odd to crosses
        if (clickCount % 2 === 0) {
            cross(this);
        } else {
            circle(this);
        ...
        if ($('#sqOne').hasClass('cross') && $('#sqFour').hasClass('cross') && $('#sqSeven').hasClass('cross')) {
            ...
            setTimeout(function() {
                swal({
                    ...
                    function() {
                        setTimeout(function() {
                            location.reload(); // where this reload css function would go
                        }, 1000);
                    });
            }, 500); //across2
        } else {}
...
// when x or o win
// a value gets stored in a
// alert pops out => rematch?
//cancel => leaves the page or something
// ok => activates removeClasses

//var removeClasses = function() {
// $(".circle, .cross").removeClass("cross");
// $(".circle, .cross").removeClass("circle");
// };
